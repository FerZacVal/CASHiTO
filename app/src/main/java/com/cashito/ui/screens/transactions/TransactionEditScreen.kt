...
import com.cashito.ui.viewmodel.TransactionEditCategory
import com.cashito.ui.viewmodel.TransactionEditUiState
...
fun TransactionEditScreen(
    ...
    LaunchedEffect(uiState.transactionUpdated) {
        if (uiState.transactionUpdated) {
...
@Composable
fun TransactionEditScreenContent(
